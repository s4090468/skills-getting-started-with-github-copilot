...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice teamwork, drills, and friendly soccer matches",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 22,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Track and Field": {
        "description": "Improve speed, endurance, and athletic performance",
    ...
    "Science Club": {
        "description": "Explore experiments, problem-solving, and scientific thinking",
        "schedule": "Tuesdays, 3:30 PM - 4:30 PM",
        "max_participants": 20,
        "participants": ["ethan@mergington.edu", "amelia@mergington.edu"]
    },
    "Math Team": {
        "description": "Challenge yourself with puzzles, logic, and advanced math problems",
